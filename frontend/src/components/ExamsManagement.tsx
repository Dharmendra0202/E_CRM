  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px" }}>
        {[
          { icon: <Award size={22} />, value: String(batches.length), label: "TOTAL BATCHES", color: "#007bff", bg: "rgba(0,123,255,0.08)" },
          { icon: <CheckCircle2 size={22} />, value: `${totalStudents}`, label: "TOTAL STUDENTS", color: "hsl(160,70%,40%)", bg: "hsla(160,70%,40%,0.08)" },
          { icon: <GraduationCap size={22} />, value: String(batchStudents.length), label: "IN SELECTED BATCH", color: "#0069d9", bg: "rgba(0,123,255,0.08)" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "20px" }}>
        ...
        {/* Report Card Preview */}
        <div style={{ background: "#fff", borderRadius: "16px", border: "1px solid rgba(0,123,255,0.15)", padding: "20px", backgroundImage: "linear-gradient(to bottom, #fff, rgba(0,123,255,0.02))" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", paddingBottom: "12px", borderBottom: "1px solid rgba(0,123,255,0.1)" }}>
            <h3 style={{ margin: 0, fontSize: "14px", fontWeight: 700, display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          {selectedStudent ? (
            <div style={{ background: "#fff", borderRadius: "14px", border: "1px solid rgba(0,123,255,0.15)", padding: "20px", boxShadow: "0 4px 16px rgba(29,10,39,0.06)" }}>
              ...
              {/* Student Info */}
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px", padding: "10px", background: "rgba(0,123,255,0.03)", borderRadius: "10px", border: "1px solid rgba(0,123,255,0.08)", marginBottom: "14px", fontSize: "11px" }}>
