  ...
  return (
    <button
      ...
      style={{
        ...
        display: "flex",
        alignItems: "center",
        border: `1px solid ${active ? "#146c54" : "#17795E"}`,
        background: hover ? "#17795E" : "#209978",
        overflow: "hidden",
        borderRadius: "8px",
        padding: 0,
        transition: trans,
    ...
    >
      ...
      <span
        style={{
          ...
          background: active ? "#146c54" : "#17795E",
          display: "flex",
          alignItems: "center",
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" style={{ width: "20px", fill: "#fff" }}>
