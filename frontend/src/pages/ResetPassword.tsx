      ...
      <div style={{ background: "#fff", borderRadius: "20px", padding: "48px 40px", maxWidth: "440px", width: "100%", boxShadow: "0 8px 40px -8px rgba(29,10,39,0.12)" }}>
        ...
        {status === "form" && (
          <>
            ...
            {errorMsg && <div style={{ background: "hsla(205, 85%, 50%,0.08)", border: "1px solid hsla(205, 85%, 50%,0.25)", padding: "10px 14px", borderRadius: "10px", fontSize: "13px", color: "var(--color-danger)", marginBottom: "16px" }}>{errorMsg}</div>}
